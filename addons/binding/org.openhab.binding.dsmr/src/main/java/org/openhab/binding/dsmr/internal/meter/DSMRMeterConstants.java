...
public class DSMRMeterConstants {
     ...
     */
    public static final long METER_VALUES_RECEIVED_TIMEOUT = TimeUnit.SECONDS.toMillis(60);
    /**
     * Period between evaluations of meter values are received
     */
    public static final long METER_VALUES_TIMER_PERIOD = TimeUnit.SECONDS.toMillis(10);
    /**
